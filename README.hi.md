...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness **`dsh-v0.1.5-rc.1`** (GitHub tag, 2026-09-10 को सत्यापित: पूर्ण गेट श्रृंखला + प्रोफ़ाइल इंस्टॉल स्मोक). npm निर्भरता लाइन: `@deepseek-ai/dsh` **0.1.5-rc.1** (peers `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`). सत्र लिफ़ाफ़ा अपना ignorable फ़ील्ड केवल संग्रहीत-लॉग पठन संगतता के लिए रखता है - Session.append अभी भी इसे स्टैम्प नहीं कर सकता, इसलिए गेट व्यवहार अपरिवर्तित है। |
...
| `vet.userAgent` | `dsh-skill-pack-security/2.2.13 (+https://github.com/PerryLink/dsh-skill-pack-security)` | डाउनलोड user-agent |
